namespace Common.Constants
{
    public class Constants
    {
        ...
        //SQL Exception Messages (thrown in PartyService)
        ...
        public const string GuestAlreadyAtPartyMessage = "There is already someone at this party with this name. Please try checking in again with a new name.";
